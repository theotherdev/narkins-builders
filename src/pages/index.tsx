...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Page section example for content below the video header */}
      <section className="text-white min-h-[80vh] flex items-center bg-cover bg-center bg-fixed" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url"(https://admin.narkinsbuilders.com/wp-content/uploads/2025/03/hcr_new-scaled.jpg)" }}>
