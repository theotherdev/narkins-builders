...
export default function Home() {
  ...
  return (
    <>
      ...
      <div>
        ...
        <header className="relative flex items-center justify-center min-h-[70vh] overflow-hidden">
          ...
          <video ref={videoRef} preload='yes' pposter='/videoframe_0.png' className="max-h-screen- absolute w-auto min-w-full min-h-full filter brightness-50 max-w-none"
            ...
            <source src="Hill Crest compressed.mp4" type="video/mp4" />
      ...
      {/* Page section example for content below the video header */}
      <section className="text-white min-h-[80vh] flex items-center bg-cover bg-center bg-fixed" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(/images/hcr_new.jpg)" }}>
