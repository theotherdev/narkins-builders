            ...
            <div className={"mt-[10rem]"}>
                <div className="mx-auto max-w-7xl pb-[5rem] gap-y-2 flex flex-col px-6 lg:px-8">
                    ...
                    <div className="py-[5rem]">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:max-xl:grid-cols-3 gap-4">
                            {[
                                // "/images/hill-crest-residency-launch-2.png",
                                // "/images/hill-crest-residency-launch.png",
                                // "/images/nbr-march.png",
                                // "/images/nbr-residency-sept.png",
                                "/images/reliability.png",
                                "/images/smart-door-lock.png",
                                "/images/smart-wifi-switches.png",
                            ].map((image, index) => (
                ...
                <div className="bg-white py-[5rem] border-t border-b-">
                    <div className="mx-auto max-w-7xl gap-y-2 flex flex-col px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:lg:grid-cols-2 gap-4">
                            <img src={"/images/hill-crest-residency-launch.png"} className="hidden md:lg:block w-full h-auto bg-neutral-100 rounded-xl cursor-pointer" />
                            ...
                            <img src={"/images/hill-crest-residency-launch-2.png"} className="w-full hidden md:lg:block h-auto bg-neutral-100 rounded-xl cursor-pointer" />
                            <div className="flex flex-col items-center md:lg:hidden">
                                <img src={"/images/hill-crest-residency-launch.png"} className="w-full h-auto bg-neutral-100 rounded-xl cursor-pointer" />
                                <p className="text-lg my-2 font-medium text-gray-900 px-[1rem]">
                                    Hill Crest Residency Completion <i>2024</i>
                                </p>
                            </div>
                            <div className="flex flex-col items-center md:lg:hidden">
                                <img src={"/images/hill-crest-residency-launch-2.png"} className="w-full bg-neutral-100 h-auto rounded-xl cursor-pointer" />
                                <p className="text-lg my-2 font-medium text-gray-900 px-[1rem]">
                                    Hill Crest Residency Launch <i>2021</i>
                                </p>
                            </div>
                ...
                <div className="bg-neutral-100 border-b py-[5rem]">
                    <div className="mx-auto max-w-7xl gap-y-2 flex flex-col px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:lg:grid-cols-2 gap-4">
                            <img src={"/images/nbr-residency-sept.png"} className="hidden md:lg:block w-full h-auto bg-neutral-100 rounded-xl cursor-pointer" />
                            <p className="text-lg my-2 font-medium text-gray-900 py-[1rem] hidden md:lg:block">
                            ...
                            <img src={"/images/nbr-march.png"} className="w-full hidden md:lg:block h-auto bg-neutral-100 rounded-xl cursor-pointer" />
                            <div className="flex flex-col items-center md:lg:hidden">
                                <img src={"/images/nbr-residency-sept.png"} className="w-full h-auto bg-neutral-100 rounded-xl cursor-pointer" />
                                <p className="text-lg my-2 font-medium text-gray-900 px-[1rem]">
                                    Narkin’s Boutique Residency <i>September 2023</i>
                                </p>
                            </div>
                            <div className="flex flex-col items-center md:lg:hidden">
                                <img src={"/images/nbr-march.png"} className="w-full bg-neutral-100 h-auto rounded-xl cursor-pointer" />
                                <p className="text-lg my-2 font-medium text-gray-900 px-[1rem]">
                                    Narkin’s Boutique Residency <i>March 2024</i>
                                </p>
                            </div>
                ...
                <section className="bg-white py-[5rem]">
                    <div className="mx-auto max-w-7xl gap-y-2 flex flex-col px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:lg:grid-cols-2 py-[5rem] gap-4">
                            <img src="/images/eastern-wear.png" className="w-full h-full object-cover rounded-xl" />
                            <img src="/images/narkins-textile-industries.png" className="w-full h-full object-cover rounded-xl" />
                        </div>
                        <div className="mx-auto max-w-2xl lg:mx-0">
                            <div className="mx-auto=max-w-2xl=lg:mx-0">
                                <p className="mt-4 text-lg leading-8 text-gray-600">Narkin's Builders continues to push the boundaries of construction and development in Karachi. We invite you to experience the Narkin's difference—where quality, reliability, and innovation converge to create exceptional living spaces.</p>
