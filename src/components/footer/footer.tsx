      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center -dark:text-gray-400">
            ...
            {' '}— All Rights Reserved · Developed by <a href="https://www.linkedin.com/in/imossaidqadri/" className='underline'>Ossaid Qadri</a> & <a href="https://theotherdev.kabeers.network" className='underline'>The Other Dev</a>
          </span>
