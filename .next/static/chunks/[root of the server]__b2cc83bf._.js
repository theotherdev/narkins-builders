(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__b2cc83bf._.js", {
...
function Blogs() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Blogs.useEffect": ()=>{
            ...
            fetch('https://admin.narkinsbuilders.com/wp-json/wp/v2/posts').then({
                "Blogs.useEffect": (response)=>response.json()
            }["Blogs.useEffect"]).then({
                "Blogs.useEffect": (data)=>{
                    setPosts(data.map({
                        "Blogs.useEffect": (post)=>({
                                id: post.id,
                ...
                "Blogs.useEffect": (error)=>console.error('Error fetching posts:', error)
            }["Blogs.useEffect"]);
        }
    }["Blogs.useEffect"], []);
...
_s(Blogs, "bG8V4duoIfO0BEPgauWMVT5Qvyw=");
_c = Blogs;
var _c;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b2cc83bf._.js.map